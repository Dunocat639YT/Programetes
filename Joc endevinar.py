...
def joc_endevina():
    ...
    #Salutació
    print(f"{YELLOW}{hora}, benvingut al joc! He pensat en un número de l'1 al 100. A veure si adivines quin!{RESET}")
    time.sleep(2)
    print(" ")
    ...
    while True: 
        ...
        # Si l'usuari és un tros de quòniam i no introdueix un número
            ...
            print(" ")
            print(f"{RED} A veure petit tros de quòniam, has d'introduir un número enter!{RESET}")
            time.sleep(2)
            print(" ")
